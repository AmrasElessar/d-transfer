> **Design reference:** [1password](https://github.com/Khalidabdi1/design-ai/blob/main/design-md/1password/DESIGN.md) — used as inspiration for d-transfer's visual direction.
> **Source:** Khalidabdi1/design-ai (MIT). Not a copy of 1password's product — extracted design *language* notes for Claude to reference when generating UI.
> **How to use:** When Claude generates new components/screens for this repo, it should consult this file for tone, hierarchy, color, motion, and spacing decisions. Override with project-specific rules in CLAUDE.md / REPO_STANDARDS.md when they conflict.
